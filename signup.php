...
<body>
    <div style="font-family: 'Courier New', Courier, monospace; margin: 0; padding: 0; background-color: #fff; height: 100%; width: 100%; padding-bottom: 5vw; background-color: #f0f8ff;">
        <center>
            <h1 style="text-transform: uppercase; padding: 2vw; background-color: #fff; color: #042A38; margin-top: 0;">Online Quiz Portal</h1>
        </center>
        <div class="seluser">
            <center>
                <button onclick="stud()">STUDENT</button>
                <button onclick="staff()">STAFF</button>
            </center>
        </div>
        <div class="stud" id="stud">
            <center>
                <form name="student" method="POST" style="width: 80vw; background-color: #fff;">
                    <br>
                    ...
                    <input type="submit" class="su" name="studsu" value="Sign-Up">
                </form>
            </center>
        </div>
        <div class="staff" id="staff">
            <center>
                <form name="staffSIGNUP" method="POST" style="width: 80vw; background-color: #fff;">
                    <br>
                    <h1 class="formname">Sign-Up as Staff</h1><br><br>
                    ...
                    <input type="submit" name="staffsu" class="su" value="Sign-Up">
                </form>
            </center>
        </div>
